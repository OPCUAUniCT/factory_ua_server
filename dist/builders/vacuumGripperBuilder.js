...
class VacuumGripperBuilder extends builder_1.SystemBuilder {
    constructor() {
        ...
        this.get_encoder_vertical_axis_impulse_2 = this.create_getter(node_opcua_1.DataType.Boolean, signalconfig_json_1.vacuumGripper.encoderVerticalAxisImpulse2);
        ...
        this.get_encoder_horizontal_axis_impulse_2 = this.create_getter(node_opcua_1.DataType.Boolean, signalconfig_json_1.vacuumGripper.encoderHorizontalAxisImpulse2);
        ...
        this.get_encoder_rotate_impulse_2 = this.create_getter(node_opcua_1.DataType.Boolean, signalconfig_json_1.vacuumGripper.encoderRotateImpulse2);
